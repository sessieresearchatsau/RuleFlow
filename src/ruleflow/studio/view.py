...
from ruleflow.studio import config
from ruleflow.studio import model
from ruleflow.core.signals import Signal  # we don't use Textual builtin signal system due to limitation with widget mounting being required first.
from ruleflow.lang import parser as flowlang_parser
...
def run_studio_app() -> App:
    """Entry point to running the studio app."""
    app = Main()
    app.run()
    return app
