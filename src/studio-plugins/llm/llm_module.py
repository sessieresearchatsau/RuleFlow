"""Implements an LLM agent for flow analysis"""
# from ollama import generate, GenerateResponse
# from typing import Literal, Any
# from functools import lru_cache
#
# # make the caller async!
# # Refine the SYSTEM prompts with context by providing the current rules and previous runs (if they exist)
# # implement a better cache system
# class LLMSelector:
